...
try {
    ...
    Write-Host "`nCommitting version changes..."
    ...
    $commitMessage = "chore: bump versions to libobs $libobsVersion, libobs-wrapper $libobsWrapperVersion, libobs-sources $libobsSourcesVersion"
