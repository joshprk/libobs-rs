...
pub fn test_output_creation() {
    ...
    output_settings.set_string("path", ObsString::new("test_output.mp4")).unwrap();
...
pub fn test_multiple_outputs() {
    ...
    settings1.set_string("path", ObsString::new("output1.mp4")).unwrap();
    ...
    settings2.set_string("path", ObsString::new("output2.mp4")).unwrap();
...
pub fn test_output_lifecycle() {
...

    {
        ...
        settings.set_string("path", ObsString::new("lifecycle_test.mp4")).unwrap();
...
pub fn test_output_different_settings() {
    ...
    let mut settings1 = context.data().unwrap();
    settings1.set_string("path", ObsString::new("minimal.mp4")).unwrap();
    ...
    let mut settings2 = context.data().unwrap();
    settings2.set_string("path", ObsString::new("configured.mp4")).unwrap();
    settings2.set_string("format_name", ObsString::new("mp4")).unwrap();
